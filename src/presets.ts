    ...
    case 'github-copilot':
      return {
        ...
        models: {
          ...
          fast: 'github-copilot/gpt-4o-mini',
          deep: 'github-copilot/o1',
        },
        agents: {
          punch: { model: 'github-copilot/gpt-4o', temperature: 0.7 },
          caesar: { model: 'github-copilot/o1', temperature: 0.2, reasoningEffort: 'high' },
          harambe: { model: 'github-copilot/gpt-4o', temperature: 0.4 },
          george: { model: 'github-copilot/gpt-4o', temperature: 0.8 },
          tasker: { model: 'github-copilot/gpt-4o-mini', temperature: 0.6, maxTokens: 2048 },
          scout: { model: 'github-copilot/gpt-4o-mini', temperature: 0.5, maxTokens: 2048 },
          builder: { model: 'github-copilot/gpt-4o-mini', temperature: 0.7, maxTokens: 2048 },
        },
        config: {
          provider,
